      ...
      try {
        ...
        if (carDoc.exists()) {
          ...
          const fallbackData = [
            ...
            { id: "16", brand: "Nissan", model: "Livina VL", year: 2019, price: 195000000, installment: 3700000, km: 48000, transmission: "Automatic", fuel: "Bensin", image: "https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=800", featured: false, description: "Nissan Livina VL 2019, basis Xpander, tanpa suspensi empuk, interior kulit." },
          ...
          if (foundCar) setCar(foundCar as Car);
        }
      } catch (error) {
